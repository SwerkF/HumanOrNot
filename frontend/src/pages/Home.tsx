  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center">
      ...
      <div className="w-1/6 flex flex-col items-center gap-3">
        <Button label="Je suis CHAUD !" className="font-bold w-full" onClick={() => navigate("/game")} />
        <Button label="Voir mes stats" className="bg-secondary font-bold text-white w-full hover:bg-primary hover:text-black transition-colors" onClick={() => navigate("/stats")} />
      </div>
    </div>
  );
};
